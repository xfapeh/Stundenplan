# Eingabedatei: Lehrer.CSV
# aus Lehrer-latex.csv die ersten beiden Zeilen löschen! -> macht sed
# Umlaute auf shell
# newline aus latex weg
# 
make_Lehrer.sh & sleep 1 && killall -9 make_Lehrer.sh
...
sleep 3
rm Lehrer-latex_main.tex Lehrer-latex.pdf Lehrer-latex.tex temp.csv
